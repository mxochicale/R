...
# Ploting the result
p <- ggplot(dt)+
     geom_line(aes(wavelenght,spc1) , size=2)+
     geom_line(aes(wavelenght,noisy), linetype="F1", size=0.2, alpha=0.5)+
     geom_line(aes(wavelenght,movav), col="red2", size=0.8)+
     geom_line(aes(wavelenght,sg1),   col="blue", size=0.8)+
     geom_line(aes(wavelenght,sg2), col="green", size=0.8)
#     ylab("y")+
#     theme_bw()
