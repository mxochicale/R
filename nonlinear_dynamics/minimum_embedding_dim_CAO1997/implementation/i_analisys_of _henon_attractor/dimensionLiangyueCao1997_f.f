...
***************************************************************************
      dimension x(1000),v(50),a(50),ya(50)
...
***************************************************************************
      ...
      open(9,file='henon_xn_N1000.dat')              ! Data file	
      !open(9,file='henon_xn_N10000.dat')              ! Data file	

      !open(10,file='E1_f.dat')
      !open(11,file='E2_f.dat')             ! Result file

      open(10,file='E1_f_N1000.dat')
      open(11,file='E2_f_N1000.dat')             ! Result file

      !open(10,file='E1_f_N10000.dat')
      !open(11,file='E2_f_N10000.dat')             ! Result file
