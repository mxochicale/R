...
VALUES = c( 1:number_of_participants, #AX
            1:number_of_participants, #AY
            1:number_of_participants, #AZ
            1:number_of_participants, #GX
            1:number_of_participants, #GY
            1:number_of_participants #GZ
          ),
...
#   #Reorder Factor:
#   text.plots$CLASSES <- factor(text.plots$CLASSES)
#   text.plots$CLASSES <- factor(text.plots$CLASSES, levels= levels(text.plots$CLASSES)[c(1,2,3)])
#
