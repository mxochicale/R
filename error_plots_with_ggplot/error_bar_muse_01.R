...
SENSOR_AXIS = c(    rep(   c( 'Ax', 'Ay', 'Az', 'G'), each =      (number_of_participants)      )  ),  # 6*each =
CLASSES =  rep(   rep(c( 'acc' ),                           each = 4*   (number_of_participants)  ), 1),
...
coord_cartesian(xlim = c(1, 4),ylim = c(0.5, 1.5))
#
